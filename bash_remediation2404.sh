...
# $ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_cis_level1_server --fix-type bash /usr/share/xml/scap/ssg/content/ssg-ubuntu2404-ds.xml
#
